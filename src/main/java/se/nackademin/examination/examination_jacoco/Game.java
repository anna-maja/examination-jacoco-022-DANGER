...
public class Game {
	...
	// oklart om denna kommer att kunna testas eftersom den itne returnerar något
	// eget...
	// relevant med exv. setGenderFromInputValus(values) och
	// getGenderFromInputValues etc?
	...
	public void run(ArrayList<String> values) {
		...
		runGame(values.get(0), values.get(1), values.get(2), getGenderFromInputValues(values),
				getAgeFromInputValues(values), values.get(5));
	}
	...
	public void buildFinalString(String firstName, String lastName, ResultFromInputs resultFromInputs,
			Conversor conversor) {
